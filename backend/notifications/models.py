...
class Notification(models.Model):
    ...
    notification_type = models.CharField(choices=NOTIFICATION_TYPES, max_length=50,default='pending')
...
def create_notification_for_Doctor(sender, instance, created, **kwargs):
    from notifications.api.serializer import NotificationSerializer  # Move import here
