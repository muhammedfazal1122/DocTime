...
export function NavbarWithSearch() {
  ...
  return (
    <Navbar className="mx-auto  max-w-screen-xl px-2 py-1 md:px-4 md:py-2">
      <div className="container mx-auto flex flex-wrap items-center justify-between text-cyan-800">
        <Typography
          as="a"
          href="#"
          ...
          <div className="flex flex-col gap-x-2 sm:flex-row sm:items-center">
            <div className="relative w-full gap-2 md:w-max">
              <Input
                ...
                className=" !border-t-blue-500 pl-9 placeholder:text-blue-800 focus:!border-blue-300"
                labelProps={{
                  className: "before:content-none after:content-none",
                }}
              />
