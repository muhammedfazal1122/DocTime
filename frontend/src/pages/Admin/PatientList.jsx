...
import EditPatient from "../../Compounts/admin/elements/Modal/EditPatient";
                ...
                {doctorData.map((item, index) => {
                  return (
                    <tr
                      ...
                      key={item.patient_user && item.patient_user.custom_id ? item.patient_user.custom_id : ""}
                    ...
                    >
                      ...
                      {item.patient_user && item.patient_user.custom_id ? item.patient_user.custom_id : ""}
                      </td>
                      <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        {item.patient_user && item.patient_user.blood_group? item.patient_user.blood_group : "" }
