...
import HorizontalCardChat from './HorizontalCardChat';


const DoctorShowChatList = () => {
        ...
        <div className="max-w-screen-xl mx-auto py-8">
          ...
          <div className="grid grid-cols-1 gap-4">
            {filteredDoctors.map((doctor) => (
              <HorizontalCardChat key={doctor.id} doctor={doctor} />
            ))}
          </div>
        </div>
      </div>
...
export default DoctorShowChatList;
